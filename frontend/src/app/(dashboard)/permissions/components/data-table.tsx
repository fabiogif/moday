...
interface DataTableProps {
  ...
  onAddPermission: (permissionData: any) => void
}
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                onClick={() => navigator.clipboard.writeText(permission.id.toString())}
              >
                Copiar ID
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => onEditPermission(permission.id)}>
    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        <div className="flex-1 text-sm text-muted-foreground">
          ...
          {table.getCoreRowModel().rows.length} permissões
        </div>
