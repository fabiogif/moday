                ...
                <div className="flex items-center space-x-3">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem className="cursor-pointer">Baixar recibo</DropdownMenuItem>
                      <DropdownMenuItem className="cursor-pointer">Entre em contato com o cliente</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
              </div>
