...
class OrderStatsApiController extends Controller
{
     ...
     *                 ),
     *                 @OA\Property(property="in_preparo_orders", type="object",
     ...
     *                 ),
     *                 @OA\Property(property="pronto_orders", type="object",
     ...
     *                     @OA\Property(property="Em Preparo", type="integer", example=30),
     *                     @OA\Property(property="Pronto", type="integer", example=100),
