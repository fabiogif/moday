...
1. **`scripts/test/test-metrics.sh`** - Teste completo dos endpoints
2. **`scripts/test/final-test.sh`** - Verificação rápida do sistema
3. **`scripts/test/test-drag-drop.sh`** - Teste do quadro de pedidos
