            ...
            <table class="table table-condensed">
                ...
                @foreach($plans as $plan)
                    <tr>
                      ...
                      <td>
                          <a href="{{ route('plans.show', $plan->url) }}" class="btn btn-info">Info</a>
                          <a href="{{ route('plans.edit', $plan->url) }}" class="btn btn-dark">Alterar</a>
                          <a href="{{ route('details.plans.index', $plan->id) }}" class="btn btn-dark">Detalhes</a>
